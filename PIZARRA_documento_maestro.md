...
- **Buscador de jugadores con autocompletado**, igual en titulares y en suplentes:
  ...
  - El **alias** que se usa para filtrar y para mostrar sobre el campo es el guardado en la Plantilla; si un jugador no tiene alias propio, se recomienda que sea su primer nombre (mismo criterio que la herramienta HTML anterior — ver 4.1).
